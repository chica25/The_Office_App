...
Quote.create(quote: "That's what she said.")
Quote.create(quote: "Identity theft is not a joke, Jim! Millions of families suffer every year.")
Quote.create(quote: "Occasionally, I'll hit somebody with my car, So sue me.")
Quote.create(quote: "Boy, have you done lost your mind? Cause I’ll help you find it!")
Quote.create(quote: "I run a small fake-ID company from my car with a laminating machine that I swiped from the Sheriff’s station.")
Quote.create(quote: "Bears, beets, Battlestar Galactica.")
Quote.create(quote: "What you want you want a cookie?")
Quote.create(quote: "People keep calling me a Wunderkind.")
Quote.create(quote: "Dinkin Flicka.")
Quote.create(quote: "And I said, 'Are you sure, Michael?' And you said, 'Pam, Pam, Pam.'")