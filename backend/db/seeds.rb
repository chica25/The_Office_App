...
Quote.create(quote: "Identity theft is not a joke, Jim! Millions of families suffer every year.", character_id: 2)
Quote.create(quote: "Occasionally, I'll hit somebody with my car, So sue me.", character_id: 3)
Quote.create(quote: "Boy, have you done lost your mind? Cause I’ll help you find it!", character_id: 4)
Quote.create(quote: "I run a small fake-ID company from my car with a laminating machine that I swiped from the Sheriff’s station.", character_id: 5)
Quote.create(quote: "Bears, beets, Battlestar Galactica.", character_id: 6)
Quote.create(quote: "What you want you want a cookie?", character_id: 7)
Quote.create(quote: "People keep calling me a Wunderkind.", character_id: 8)
Quote.create(quote: "Dinkin Flicka.", character_id: 9)
Quote.create(quote: "And I said, 'Are you sure, Michael?' And you said, 'Pam, Pam, Pam.'", character_id: 10)